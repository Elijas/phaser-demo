var gameProperties = {
    screenWidth: Math.max(window.innerWidth, document.documentElement.clientWidth),
    screenHeight: Math.max(window.innerHeight,document.documentElement.clientHeight),
};
